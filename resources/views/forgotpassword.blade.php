...
<head>
    ...
    <title>Forgot Password Page - Bootstrap HTML admin template</title>
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid" src="{{ URL::asset('/bundleku/app-assets/images/pages/forgot-password-v2.svg') }}"
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="text-center mt-2"><a href="auth-login-cover.html"><i
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ URL::asset('/bundleku/app-assets/js/scripts/pages/auth-forgot-password.js') }}"></script>
    <!-- END: Page JS-->
