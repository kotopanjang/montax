            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ URL::asset('/bundleku/app-assets/images/pages/eCommerce/1.png') }}" alt="donuts" width="62">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ URL::asset('/bundleku/app-assets/images/pages/eCommerce/7.png') }}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ URL::asset('/bundleku/app-assets/images/pages/eCommerce/2.png') }}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ URL::asset('/bundleku/app-assets/images/pages/eCommerce/3.png') }}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ URL::asset('/bundleku/app-assets/images/pages/eCommerce/5.png') }}" alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                                        <h6 class="cart-item-title"><a class="text-body"
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">John Doe</span><span
                                ...
                                src="{{ URL::asset('/bundleku/app-assets/images/portrait/small/avatar-s-11.jpg') }}" alt="avatar" height="40"
