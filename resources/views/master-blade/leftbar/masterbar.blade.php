<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('dashboard')}}"><i
        ...
        {{-- <ul class="menu-content">
            ...
            <li class="active"><a class="d-flex align-items-center" href="{{route('dashboard')}}"><i
    ...
    <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('aset_WP')}}"><i
    ...
    <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('dana_impian_WP')}}"><i data-feather="mail"></i><span
                class="menu-title text-truncate">Dana Impian</span></a>
    </li>
    <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('financial_check_up')}}"><i
                data-feather="mail"></i><span class="menu-title text-truncate" data-i18n="Email">Financial Check
                Up</span></a>
    </li>
