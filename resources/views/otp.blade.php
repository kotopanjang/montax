...
<head>
    ...
    <title>Two Steps Verification Cover - Vuexy - Bootstrap HTML admin template</title>
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click"
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid"
                                    src="{{ URL::asset('/bundleku/app-assets/images/illustration/two-steps-verification-illustration.svg') }}"
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-75">We sent a verification code to your mobile. Enter the code
                                    from the mobile in the field below.</p>
                                ...
                                <p class="text-center mt-2"><span>Didn&rsquo;t get the code?</span><a
                                        href="Javascript:void(0)"><span>&nbsp;Resend</span></a><span>or</span><a
                                        href="Javascript:void(0)"><span>&nbsp;Call Us</span></a></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ URL::asset('/bundleku/app-assets/js/scripts/pages/auth-two-steps.js') }}"></script>
    <!-- END: Page JS-->
