...
<script>
  ...
  Chart_3(current_year);
  Chart_4(current_year);
  Chart_5(current_year);
  Chart_6(current_year);
  ...
  function Chart_5(paramtahun)
  {
    var varparamtahun = paramtahun
    $.ajax({
            type: 'POST',
            url: myurl + '/FU_chart_5',
            ...
            success: function(msg){
                ...
                extension_chart_5(msg.jenis,msg.jumlah);
            },
  ...
  function extension_chart_5(paramdata_c51,paramdata_c52)
  {
    ...
    chartdistribusipemasukan = new Chart(oilCanvas, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      data: paramdata_c52,
                      value: value,
                      backgroundColor: ['blue', '#FF6384','orange','green','navy','silver','gold','purple'],
                      borderWidth: 2
                    }]
                  },
                  options: {
  ...
  function Chart_6(paramtahun)
  {
    var varparamtahun = paramtahun
    $.ajax({
            type: 'POST',
            url: myurl + '/FU_chart_6',
            data: {idparamth: varparamtahun},
            cache: false,
            success: function(msg){
                // alert('pesan : ' + msg);
                ...
                // $("#title_penghasilan_utama").html(msg.utama);
                // $("#title_penghasilan_non_utama").html(msg.non_utama);
                extension_chart_6(msg.jenis,msg.jumlah);
            },
            error: function(result) {
                alert('error');
            }
  ...
  function extension_chart_6(paramdata_c61,paramdata_c62)
  {
  ...
  function Chart_3(paramtahun)
  {
    var varparamtahun = paramtahun
      $.ajax({
          type: 'POST',
          url: myurl + '/FU_chart_3',
          data: {idparamth: varparamtahun},
          cache: false,
          success: function(msg){
  ...
  function extension_chart_3(paramdata_c3)
  {
  ...
  function Chart_4(paramtahun)
  {
    var varparamtahun = paramtahun
      $.ajax({
          type: 'POST',
          url: myurl + '/FU_chart_4',
          data: {idparamth: varparamtahun},
          cache: false,
          success: function(msg){
              // alert('pesan : ' + msg.kalimat);
  ...
  function extension_chart_4(paramdata_c4)
  {
...
<script>
  var ctx = document.getElementById("chart_rasio_dana_impian").getContext("2d");

  var data = {
  labels: ['Dana Liburan','Dana Pendidikan','Dana Upgrading'],
  datasets: [{
          label: "Dana Impian",
          backgroundColor: "green",
          data: [2500000,4000000,2000000]
      }, {
          label: "Tabungan",
          backgroundColor: "orange",
          data: [2000000,4000000,1700000]
      }]
  };
