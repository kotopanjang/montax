            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <form action="{{ URL::route('create_pemasukan_pdf')}}" method="post">
                                @csrf
                            ...
                            <button type="reset" class="btn btn-outline-secondary" name="btnReset" id="btnReset" onclick="show_datatable()">Reset</button>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    function filter_data()
    {
        ...
        if(tgl_start == "" || tgl_end == "")
        {
            ...
            var tabel = $('#example').DataTable({
                ...
                "ajax":
                {
                    "url": myurl + '/pemasukan_datatable_param' + '/' + tgl_start + '/' + tgl_end,
                    "type": "GET",
                },
                columnDefs: [
                    {
