                            ...
                            <div class="width-800 mx-auto">
                                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                                    <div class="content-header mb-2">
                                        <h2 class="fw-bolder mb-75 mt-3">Select WP</h2>
                                        <span>Select your user WP Account</span>
                                    </div>
                                        ...
                                        <form>
                                            ...
                                            {{-- <div class="row custom-options-checkable gx-3 gy-2">
                                                <div class="col-md-4">
                                                    ...
                                                    <label class="custom-option-item text-center p-1" for="basicPlan">
                                                        <span class="custom-option-item-title h3 fw-bolder">User I</span>
                                                        <span class="d-block m-75">Username A</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <label class="custom-option-item text-center p-1" for="standardPlan">
                                                        <span class="custom-option-item-title h3 fw-bolder">User II</span>
                                                        <span class="d-block m-75">Username B</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <label class="custom-option-item text-center p-1" for="enterprisePlan">
                                                        <span class="custom-option-item-title h3 fw-bolder">User III</span>
                                                        <span class="d-block m-75">Username C</span>
                                                    </label>
                                                </div>
                                            </div> --}}
                                            ...
                                            <div class="row">
                                                <?php
                                                    $counter = 1;
                                                ?>
                                                @foreach ($user_saya as $row_user_saya)
                                                <div class="col-12 col-md-4">
                                                    <div class="card basic-pricing text-center">
                                                        <div class="card-body">
                                                            <img src="{{ URL::asset('/bundleku/app-assets/images/illustration/Pot1.svg') }}" class="mb-2 mt-2" alt="svg img" />
                                                            <h3>WP <?php echo $counter;?></h3>
                                                            <p class="card-text">Nama : {{$row_user_saya->nama_lengkap}}</p>
                                                            <ul class="list-group list-group-circle text-start">
                                                                <li class="list-group-item">NWPWP</li>
                                                                <li class="list-group-item">Status</li>
                                                                <li class="list-group-item">Total</li>
                                                            </ul>
                                                            {{-- <button class="btn w-100 btn-outline-success mt-2"></button> --}}
                                                            <a href="{{ route('masuk_user',['paramid' => $row_user_saya->id])}}" class="btn w-100 btn-outline-primary">Masuk</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php
                                            ...
                                            <div class="content-header my-2 py-1">
                                                <h2 class="fw-bolder mb-75">Information</h2>
